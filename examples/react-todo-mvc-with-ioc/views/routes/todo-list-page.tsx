...
function todoListPage(props: TodoListPagePropsInterface) {
  return (
    <React.Fragment>
      <input id="toggle-all" className="toggle-all" type="checkbox" checked={props.completedAll} onChange={() => {
...
export const TodoListPage = connect<{todos: TodoInterface[], completedAll: boolean}, Omit<TodoListPagePropsInterface, 'todos' | 'completedAll'>>((state: any) => {
